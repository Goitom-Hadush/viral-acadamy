...
export default function InstructorLayout({ children }) {
    ...
    const { auth = { user: { name: 'Instructor' } } } = props;
    const [sidebarOpen, setSidebarOpen] = useState(false);
    const navigation = useMemo(() => ([
        {
            label: 'Dashboard',
            href: '/instructor/dashboard',
            active: url.startsWith('/instructor/dashboard'),
            icon: (
        ...
        },
        {
            ...
            active: url.startsWith('/instructor/courses'),
            icon: (
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            active: url.startsWith('/instructor/students'),
            icon: (
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            active: url.startsWith('/instructor/reviews'),
            icon: (
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex min-w-0 items-center gap-4">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="hidden text-sm text-slate-500 sm:block">Instructor workspace</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
